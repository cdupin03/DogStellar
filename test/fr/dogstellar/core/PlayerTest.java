...
/**
 * The test class PlayerTest. A player have a name, a number of LifePoint and
 * number of AttackPoint and an inventory (inherit to perso) He can use the
 * stuff in the inventory to equipped him
 *
 * @author GP3
 * @version 20/11/2017
 */
public class PlayerTest {
    ...
    /**
     * Test if the getter of armorEquip well return the armor of the Player
     * equipment
     */
    @Test
    ...
    /**
     * Test if the getter of weaponEquip well return the weapon of the Player
     * equipment
     */
    @Test
