 ...
 * First it test the creation of a armor piece of stuff and 
 * search if the object created have the name and description entered. If the name and description
 * work, the test success.
 * Then it try to create a armor with a armorpoint above the range. The result must be 1
 * . If the armorPoint is 1 the test success.
 * Then it try to create a armor with a armorpoint under the range. The result must be 1
 * . If the armorPoint is 1 the test success.
 * @author  (G3)
 * @version (01)
 */
public class ArmorTest
{
     ...
     * Create a Armor with value(name, description) and test if the values enter are right
