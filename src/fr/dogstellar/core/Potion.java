...
/**
 * This class represent a potion which add life point when drunk. LifePoint must
 * be between 1 and 13. If a wrong value is given, the lifePoint is initialized
 * to 1.
 *
 *
 * @author (G3)
...
public class Potion extends Stuff {
     ...
     * description is managed by the info class. If the point is inferior to 0
     * or superior to 13, the lifePoint given is initialized to 1.
     *
